...
from utils_vicuna import disable_torch_init
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, default="/home/quansun84/stanford_alpaca/output/test_clean_alpaca/checkpoint-2000")
